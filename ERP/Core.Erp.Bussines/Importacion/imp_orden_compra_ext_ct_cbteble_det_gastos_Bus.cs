    ...
    public class imp_orden_compra_ext_ct_cbteble_det_gastos_Bus
    {
        ...
        public List<imp_orden_compra_ext_ct_cbteble_det_gastos_Info> get_list(int IdEmpresa, decimal IdOrdenCompra_ext)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "get_list", ex.Message), ex) { EntityType = typeof(imp_orden_compra_ext_ct_cbteble_det_gastos_Bus) };
            }
        }
        ...
        public bool guardarDB(List<imp_orden_compra_ext_ct_cbteble_det_gastos_Info> Lista)
        {
            ...
            {
                Core.Erp.Info.Log_Exception.LoggingManager.Logger.Log(Core.Erp.Info.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "guardarDB", ex.Message), ex) { EntityType = typeof(imp_orden_compra_ext_ct_cbteble_det_gastos_Bus) };
            }
        }
        ...
        public bool eliminarDB(int IdEmpresa, decimal IdOrdenCompra_ext)
        {
            ...
            {
                Core.Erp.Info.Log_Exception.LoggingManager.Logger.Log(Core.Erp.Info.Log_Exception.LoggingCategory.Error, ex.Message);
                throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "eliminarDB", ex.Message), ex) { EntityType = typeof(imp_orden_compra_ext_ct_cbteble_det_gastos_Bus) };
            }
        }
    }
}
