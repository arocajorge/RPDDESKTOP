...
AS
SELECT dbo.fa_proforma_det.IdEmpresa, dbo.fa_proforma_det.IdSucursal, dbo.fa_proforma_det.IdProforma, dbo.fa_proforma_det.Secuencia, dbo.fa_TerminoPago.nom_TerminoPago, dbo.fa_proforma.pf_plazo, dbo.fa_proforma.pf_codigo, 
                  dbo.fa_proforma.pf_fecha, dbo.fa_proforma.estado, dbo.fa_proforma.pf_atencion_a, dbo.fa_Vendedor.Codigo, dbo.fa_Vendedor.Ve_Vendedor, dbo.in_Producto.pr_descripcion, dbo.fa_proforma_det.pd_cantidad, 
                  dbo.fa_proforma_det.pd_precio, dbo.fa_proforma_det.pd_por_descuento_uni, dbo.fa_proforma_det.pd_descuento_uni, dbo.fa_proforma_det.pd_precio_final, dbo.fa_proforma_det.pd_subtotal, dbo.fa_proforma_det.pd_por_iva, 
                  dbo.fa_proforma_det.pd_iva, dbo.fa_proforma_det.pd_total, dbo.in_Marca.Descripcion AS nom_marca, dbo.in_presentacion.nom_presentacion AS nom_modelo, dbo.in_Producto.pr_observacion, dbo.fa_proforma_det.IdProducto, 
                  dbo.fa_proforma.pr_dias_entrega, dbo.fa_proforma.pf_observacion, IIF(dbo.in_Producto.se_distribuye != 1, dbo.in_Producto.lote_num_lote, NULL) lote_num_lote, IIF(dbo.in_Producto.se_distribuye != 1, 
                  dbo.in_Producto.lote_fecha_vcto, NULL) lote_fecha_vcto, in_Producto.IdProducto_padre
