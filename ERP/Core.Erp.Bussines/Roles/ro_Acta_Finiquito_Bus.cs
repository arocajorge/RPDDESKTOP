...
namespace Core.Erp.Business.Roles
{
    public class ro_Acta_Finiquito_Bus
    {
        ...
        List<ro_Acta_Finiquito_Detalle_Info> lst_acta_finiquito_detalle = new List<ro_Acta_Finiquito_Detalle_Info>();
            ...
            try
            {
                ...
                { //PROVISION DECIMO TERCER
                    ...
                    if (totalRubroAcumulado > 0)
                    {
                        ...
                        lst_acta_finiquito_detalle.Add(item);
                    }
            ...
            try
            {
                ...
                if (_Info != null)
                {
                    ...
                    if (totalRubroAcumulado > 0)
                    {
                            ...
                            info_va.IdRubro = info_parametro.IdRubro_acta_finiquito;
