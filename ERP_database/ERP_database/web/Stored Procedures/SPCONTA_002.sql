--exec web.SPCONTA_002 1,110101,'2018/06/01','2018/12/31'
...
isnull(@SaldoInicial,0) + SUM(ct_cbtecble_det.dc_Valor) OVER(partition by ct_cbtecble_det.IdEmpresa, ct_cbtecble_det.IdCtaCble ORDER BY ct_cbtecble_det.IdEmpresa, ct_cbtecble_det.IdCtaCble,ct_cbtecble.cb_Fecha, ct_cbtecble_det.IdTipoCbte, ct_cbtecble_det.IdCbteCble, ct_cbtecble_det.secuencia) as Saldo,
