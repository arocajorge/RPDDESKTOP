...
namespace Core.Erp.Reportes
{
    ...
    public partial class EntitiesCXP_General : DbContext
    {
        ...
        public virtual ObjectResult<spCXP_Rpt001_Result> spCXP_Rpt001(Nullable<int> idEmpresa, Nullable<decimal> idProveedor_ini, Nullable<decimal> idProveedor_fin, Nullable<int> idClase_proveedor_ini, Nullable<int> idClase_proveedor_fin, Nullable<System.DateTime> fecha_corte)
        {
            var idEmpresaParameter = idEmpresa.HasValue ?
                new ObjectParameter("IdEmpresa", idEmpresa) :
                new ObjectParameter("IdEmpresa", typeof(int));
            ...
            var idClase_proveedor_iniParameter = idClase_proveedor_ini.HasValue ?
                new ObjectParameter("IdClase_proveedor_ini", idClase_proveedor_ini) :
                new ObjectParameter("IdClase_proveedor_ini", typeof(int));
    
            var idClase_proveedor_finParameter = idClase_proveedor_fin.HasValue ?
                new ObjectParameter("IdClase_proveedor_fin", idClase_proveedor_fin) :
                new ObjectParameter("IdClase_proveedor_fin", typeof(int));
    
            var fecha_corteParameter = fecha_corte.HasValue ?
                new ObjectParameter("Fecha_corte", fecha_corte) :
                new ObjectParameter("Fecha_corte", typeof(System.DateTime));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spCXP_Rpt001_Result>("spCXP_Rpt001", idEmpresaParameter, idProveedor_iniParameter, idProveedor_finParameter, idClase_proveedor_iniParameter, idClase_proveedor_finParameter, fecha_corteParameter);
        }
    }
}
