...
SELECT        A.IdEmpresa, A.IdCbteCble_Ogiro, A.IdTipoCbte_Ogiro, A.IdOrden_giro_Tipo, A.IdProveedor, A.co_fechaOg, A.co_serie, A.co_factura, A.co_FechaFactura, 
                         ...
                         A.IdCtaCble_Gasto, A.IdCtaCble_IVA, A.IdUsuario, A.Fecha_Transac, A.Estado, A.IdUsuarioUltMod, A.Fecha_UltMod, A.IdUsuarioUltAnu, A.MotivoAnu, A.nom_pc, A.ip, 
                         A.Fecha_UltAnu, A.co_retencionManual, A.IdCbteCble_Anulacion, A.IdTipoCbte_Anulacion, em.em_nombre, A.IdCentroCosto, cbtp.tc_TipoCbte, A.IdSucursal, 
                         ...
                         cp_retencion_1.NumRetencion AS re_NumRetencion, cp_retencion_1.re_EstaImpresa, A.co_propina, A.co_IRBPNR, 
...
GROUP BY A.IdEmpresa, A.IdCbteCble_Ogiro, A.IdTipoCbte_Ogiro, A.IdOrden_giro_Tipo, A.IdProveedor, A.co_fechaOg, A.co_serie, A.co_factura, A.co_FechaFactura, 
                         ...
                         A.IdTipoCbte_Anulacion, em.em_nombre, A.IdCentroCosto, cbtp.tc_TipoCbte, A.IdSucursal, su.Su_Descripcion, A.IdTipoFlujo, flu.Descricion, A.PagoLocExt, 
                         ...
                         cp_retencion_1.NumRetencion, cp_retencion_1.re_EstaImpresa, A.co_propina, A.co_IRBPNR, pag.TotalPagado, dbo.vwCP_Retencion_Valor_total.Total_Retencion, 
                         A.cp_es_comprobante_electronico, A.Tipodoc_a_Modificar, A.estable_a_Modificar, A.ptoEmi_a_Modificar, A.num_docu_Modificar, A.aut_doc_Modificar, 
