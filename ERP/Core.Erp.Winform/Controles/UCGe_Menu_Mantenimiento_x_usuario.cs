...
namespace Core.Erp.Winform.Controles
{
    public partial class UCGe_Menu_Mantenimiento_x_usuario : UserControl
    {
        ...
        public delegate void delegate_btn_distribuir_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e);
        public event delegate_btn_distribuir_ItemClick event_btn_distribuir_ItemClick;
        #endregion
        ...
        public UCGe_Menu_Mantenimiento_x_usuario()
        {
            try
            {
                ...
                event_btn_distribuir_ItemClick += UCGe_Menu_Mantenimiento_x_usuario_event_btn_distribuir_ItemClick;
        ...
        void UCGe_Menu_Mantenimiento_x_usuario_event_btn_distribuir_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
        ...
        public DevExpress.XtraBars.BarItemVisibility Visible_btn_distribuir
        {
            get { return this.btn_distribuir.Visibility; }
            set { this.btn_distribuir.Visibility = value; }
        }
        ...
        private void btn_distribuir_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                event_btn_distribuir_ItemClick(sender, e);
            }
            catch (Exception)
            {
