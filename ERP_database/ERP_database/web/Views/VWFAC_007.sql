...
SELECT        fa_factura_det.IdEmpresa, fa_factura_det.IdSucursal, fa_factura_det.IdBodega, fa_factura_det.IdCbteVta, fa_factura_det.Secuencia, fa_factura_det.IdProducto, in_Producto.pr_descripcion, in_presentacion.nom_presentacion, 
                         in_Producto.lote_num_lote, in_Producto.lote_fecha_vcto, fa_factura_det.vt_cantidad, fa_factura_det.vt_Precio, fa_factura_det.vt_PorDescUnitario, fa_factura_det.vt_Subtotal, fa_factura_det.vt_DescUnitario * fa_factura_det.vt_cantidad as DescTotal,
						 IIF(vt_por_iva > 0, vt_Subtotal,0) as vt_SubtotalIVA, IIF(vt_por_iva = 0, vt_Subtotal,0) as vt_Subtotal0,fa_factura_det.vt_iva, fa_factura_det.vt_total, 
                         ...
                         fa_Vendedor.Ve_Vendedor, fa_TerminoPago.nom_TerminoPago, fa_TerminoPago.Num_Coutas
