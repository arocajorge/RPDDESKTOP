...
SELECT        OC.IdEmpresa, OC.IdSucursal, OC.IdOrdenCompra, OC.IdProveedor, OC.oc_NumDocumento, OC.Tipo, OC.IdTerminoPago, OC.oc_plazo, OC.oc_fecha, OC.oc_flete, 
                         ...
                         OC.IdDepartamento, OC.Solicitante, OC.IdSolicitante, OC.IdComprador, OC.MotivoAnulacion, Perso_Soli.pe_nombreCompleto AS Nom_Solicita, 
...
FROM            dbo.com_ordencompra_local AS OC INNER JOIN
                         ...
                         dbo.tb_persona AS Perso_Soli ON OC.IdSolicitante = Perso_Soli.IdPersona
...
GROUP BY OC.IdEmpresa, OC.IdSucursal, OC.IdOrdenCompra, OC.IdProveedor, OC.oc_NumDocumento, OC.Tipo, OC.IdTerminoPago, OC.oc_plazo, OC.oc_fecha, OC.oc_flete, 
                         OC.oc_observacion, OC.Estado, OC.IdEstadoAprobacion_cat, OC.co_fecha_aprobacion, OC.IdUsuario_Aprueba, OC.IdUsuario_Reprue, OC.co_fechaReproba, 
                         OC.Fecha_Transac, OC.Fecha_UltMod, OC.IdUsuarioUltMod, OC.FechaHoraAnul, OC.IdUsuarioUltAnu, OC.IdSolicitante, OC.AfectaCosto, OC.MotivoReprobacion, 
                         Apr.descripcion, PAgo.descripcion, REc.descripcion, pe.pe_nombreCompleto, dbo.tb_sucursal.Su_Descripcion, OC.IdDepartamento, OC.Solicitante, OC.IdSolicitante, 
                         ...
                         com_x_sol.scd_IdSolicitudCompra, OC.IdEstadoRecepcion_cat