      ...
      //  UCIn_CtsContablesParaContabilizar ctrl_ctasContables;
        ...
        public void set_categoria(in_categorias_Info categoriaInfo)
        {
            try
            {
                ...
                cmb_plancta_costo.set_IdCtaCble(_categorioInfo.IdCtaCtble_Costo);
                cmb_plancta_inven.set_IdCtaCble(_categorioInfo.IdCtaCtble_Inve);
                cmb_plancta_vta.set_IdCtaCble(_categorioInfo.IdCtaCble_venta);
        ...
        private void get_categoria()
        {
            try
            {
                ...
                if (cmb_plancta_costo.get_CuentaInfo().IdCtaCble == "") infoCat.IdCtaCtble_Costo = null; else infoCat.IdCtaCtble_Costo = cmb_plancta_costo.get_CuentaInfo().IdCtaCble;
                if (cmb_plancta_inven.get_CuentaInfo().IdCtaCble == "") infoCat.IdCtaCtble_Inve = null; else infoCat.IdCtaCtble_Inve = cmb_plancta_inven.get_CuentaInfo().IdCtaCble;
                if (cmb_plancta_vta.get_CuentaInfo().IdCtaCble == "") infoCat.IdCtaCble_venta = null; else infoCat.IdCtaCble_venta = cmb_plancta_vta.get_CuentaInfo().IdCtaCble;
