    ...
    public partial class frmRo_ActaFiniquito : Form
    {
        ...
        public void pu_CargarIngresos()
        {
            try
            {
                ...
                oBListRo_Acta_Finiquito_Detalle_Ingresos_Info = new BindingList<ro_Acta_Finiquito_Detalle_Info>(oRo_Acta_Finiquito_Detalle_Bus.GetListConsultaPorId(_Info.IdEmpresa, _Info.IdEmpleado, _Info.IdActaFiniquito));
        ...
        public void pu_CargarEgresos()
        {
            try
            {
                oBListRo_Acta_Finiquito_Detalle_Egresos_Info = new BindingList<ro_Acta_Finiquito_Detalle_Info>(oRo_Acta_Finiquito_Detalle_Bus.GetListConsultaPorId(_Info.IdEmpresa, _Info.IdEmpleado, _Info.IdActaFiniquito));
