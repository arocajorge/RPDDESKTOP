...
namespace Core.Erp.Winform.Facturacion
{
    public partial class frmFa_Saldo_inicial_ImportWizard : Form
    {
        ...
        private void lblLink_Click(object sender, EventArgs e)
        {
            ...
            if (saveFileDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                File.WriteAllBytes(@filePath, Properties.Resources.Plantilla_Ejemplo_CXC_ND_Saldo_inicial);
    ...
    class cl_estado_grabacion_Saldo_inicial_ND
    {
        ...
        public cl_estado_grabacion_Saldo_inicial_ND(int _Secuencia,decimal _IdNota, decimal IdProveedor, string _pr_nombre, int _IdTipoCbte, decimal _IdCbteCble, string _num_Fact, DateTime _Fecha, DateTime _Fecha_vcto, DateTime _Fecha_contabilizacion, double _Saldo)
        {
