...
FROM            tb_persona INNER JOIN
                         ...
                         [web].[in_SPINV_005] ON in_Producto.IdEmpresa = [web].[in_SPINV_005].IdEmpresa AND in_Producto.IdProducto = [web].[in_SPINV_005].IdProducto ON 
                         det.IdEmpresa = [web].[in_SPINV_005].IdEmpresa AND det.IdSucursal = [web].[in_SPINV_005].IdSucursal AND det.IdBodega = [web].[in_SPINV_005].IdBodega AND 
                         det.IdProducto = [web].[in_SPINV_005].IdProducto INNER JOIN
