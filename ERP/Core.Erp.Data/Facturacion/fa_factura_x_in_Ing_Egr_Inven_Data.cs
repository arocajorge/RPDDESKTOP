            ...
            try
            {
                using (EntitiesFacturacion Context = new EntitiesFacturacion())
                {
                    fa_factura_x_in_Ing_Egr_Inven address = new fa_factura_x_in_Ing_Egr_Inven{
                     ...
                     IdEmpresa_fa = info.IdEmpresa_fa,
                     IdSucursal_fa = info.IdSucursal_fa,
                     IdBodega_fa = info.IdBodega_fa,
                     IdCbteVta_fa = info.IdCbteVta_fa,
                     IdEmpresa_in_eg_x_inv = info.IdEmpresa_in_eg_x_inv,
                     IdSucursal_in_eg_x_inv = info.IdSucursal_in_eg_x_inv,
                     IdMovi_inven_tipo_in_eg_x_inv = info.IdMovi_inven_tipo_in_eg_x_inv,
                     IdNumMovi_in_eg_x_inv = info.IdNumMovi_in_eg_x_inv,
