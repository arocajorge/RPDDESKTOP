    ...
    public partial class FrmGe_Impuesto_Mant : Form
    {
        ...
        private void SetInfo()
        {
            try
            {
                ...
                cmb_plan_vta.set_PlanCtarInfo(Info_Impuesto.Info_sis_Impuesto_x_ctacble.IdCtaCble_vta);            
            }
            catch (Exception ex)
            {
                Log_Error_bus.Log_Error(ex.ToString());
        ...
        private tb_sis_impuesto_Info GetInfo()
        {
            try
            {
                ...
                Info_Impuesto_x_ctacble.IdCtaCble_vta = cmb_plan_vta.get_PlanCtaInfo().IdCtaCble;
