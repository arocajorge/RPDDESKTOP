    ...
    public partial class frmRo_Solicitud_Vacaciones_Cons : Form
    {
        ...
        void ucGe_Menu_Mantenimiento_x_usuario_event_btnAnular_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                if (info.Estado == "I")
                {
                    MessageBox.Show("La Solicitud No. " + info.IdSolicitud + " ya se encuentra ANULADA:", "ATENCION", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                    return;
                }
                else
                {
                    ...
                    else
                    {
                        ...
                        if (MessageBox.Show("¿Está seguro que desea anular la Solicitud No. " + info.IdSolicitud + " ? ", "Anulación", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                        {
                            pu_AnularSolicitud();
                            int id = 0;
