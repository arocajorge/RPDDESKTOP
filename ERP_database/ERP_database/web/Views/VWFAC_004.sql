...
SELECT        dbo.fa_notaCreDeb.IdEmpresa, dbo.fa_notaCreDeb.IdSucursal, dbo.fa_notaCreDeb.IdBodega, dbo.fa_notaCreDeb.IdNota, dbo.fa_notaCreDeb_det.Secuencia, dbo.fa_TipoNota.CodTipoNota, 
                         ...
                         dbo.fa_notaCreDeb.IdVendedor, dbo.tb_persona.pe_nombreCompleto, dbo.tb_persona.pe_cedulaRuc, NULL AS pe_telefonoCasa, dbo.tb_persona.pe_direccion, dbo.fa_Vendedor.Ve_Vendedor, dbo.fa_notaCreDeb.no_fecha, 
                         ...
                         dbo.fa_notaCreDeb.IdDevolucion, dbo.fa_notaCreDeb.interes, dbo.fa_notaCreDeb_det.sc_cantidad, dbo.fa_notaCreDeb_det.sc_Precio, dbo.fa_notaCreDeb_det.sc_subtotal, dbo.fa_notaCreDeb_det.sc_iva, 
                         ...
                         dbo.fa_notaCreDeb.valor1 + dbo.fa_notaCreDeb.valor2 + dbo.fa_notaCreDeb.flete AS valorFlete, dbo.fa_notaCreDeb.IdCaja, dbo.caj_Caja.ca_Descripcion AS Caja
