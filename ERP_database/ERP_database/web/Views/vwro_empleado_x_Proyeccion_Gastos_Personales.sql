...
AS
SELECT        dbo.ro_empleado_proyeccion_gastos.IdEmpresa, dbo.ro_empleado_proyeccion_gastos.IdEmpleado, dbo.ro_empleado_proyeccion_gastos.AnioFiscal, dbo.tb_persona.pe_cedulaRuc, dbo.tb_persona.pe_nombreCompleto
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[35] 4[5] 2[36] 3) )"
      End
   ...
   Begin DiagramPane = 
      ...
      Begin Tables = 
         ...
         Begin Table = "tb_persona"
            ...
            TopColumn = 0
         End
         Begin Table = "ro_empleado_proyeccion_gastos"
            Begin Extent = 
               Top = 6
               Left = 668
               Bottom = 252
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'web', @level1type = N'VIEW', @level1name = N'vwro_empleado_x_Proyeccion_Gastos_Personales';
