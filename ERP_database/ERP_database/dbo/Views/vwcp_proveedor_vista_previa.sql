...
SELECT        dbo.cp_proveedor.IdEmpresa, dbo.cp_proveedor.IdProveedor, dbo.cp_proveedor.IdPersona, dbo.cp_proveedor.pr_codigo, dbo.cp_proveedor.pr_nombre, 
                         ...
                         cp_codigo_SRI_2.co_descripcion AS nom_Credito_Predeter, null pe_fax, null pe_casilla, null pe_telefonoCasa, 
                         null pe_telefonoOfic, dbo.tb_persona.IdEstadoCivil, dbo.tb_persona.pe_fechaNacimiento, dbo.tb_persona.pe_apellido, dbo.tb_persona.pe_nombre, 
