...
SELECT        TOP (100) PERCENT act.IdEmpresa, act.IdActivoFijo, act.Af_Codigo_Barra, 0 IdTipoDepreciacion, ' ' cod_tipo_depreciacion, 'lineal' nom_tipo_depreciacion, 
                         ...
                         det.Secuencia, det.Ciclo, det.Valor_Compra, det.Valor_Salvamento, det.Vida_Util, det.Valor_Depreciacion, det.Valor_Depre_Acum, det.Valor_Importe, ct.IdPeriodo, 
