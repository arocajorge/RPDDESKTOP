    ...
    public partial class UCGe_PaisProvinciaCiudad : UserControl
    {
        ...
        public tb_pais_Info get_Info_Pais()
        {
            try
            {
                ...
                if (cmbPais.EditValue != null)
                    InfoPais = lstInfoPais.FirstOrDefault(v => v.IdPais == Convert.ToString(cmbPais.EditValue));
                else
                    return null;
                return InfoPais;
            }
        ...
        public tb_provincia_Info get_Info_Provincia()
        {
            ...
            {
                if (cmbProvincia.EditValue != null)
                    InfoProvincia = lstInfoProvincia.FirstOrDefault(v => v.IdProvincia == Convert.ToString(cmbProvincia.EditValue));
                else
                    return null;
