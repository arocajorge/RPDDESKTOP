    ...
    public partial class UCIn_MotivoInvCmb : UserControl
    {
        ...
        public void cargar_MotivoInv()
        {
            try
            {
                ...
                if (listMotivoInv.FirstOrDefault(q => q.Genera_Movi_Inven == "S") != null) cmbMotivoInv.EditValue = listMotivoInv.First(q => q.Genera_Movi_Inven == "S").IdMotivo_Inv;
            }
            catch (Exception ex)
            {
                string NameMetodo = System.Reflection.MethodBase.GetCurrentMethod().Name;
