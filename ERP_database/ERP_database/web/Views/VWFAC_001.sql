...
as
SELECT        dbo.fa_factura_det.IdEmpresa, dbo.fa_factura_det.IdSucursal, dbo.fa_factura_det.IdBodega, dbo.fa_factura_det.IdCbteVta, dbo.fa_factura_det.Secuencia, dbo.fa_factura_det.IdProducto, ISNULL(dbo.in_Producto.IdProducto_padre, 
                         0) AS IdProducto_padre, dbo.fa_factura.vt_NumFactura, dbo.fa_factura.IdCliente, dbo.fa_factura.IdContacto, dbo.fa_cliente_contactos.Nombres AS NombreContacto, dbo.fa_factura.IdVendedor, dbo.fa_Vendedor.Ve_Vendedor, 
                         LTRIM(RTRIM(dbo.tb_persona.pe_nombreCompleto)) AS NombreCliente, dbo.in_Producto.pr_descripcion + ' ' +dbo.in_presentacion.nom_presentacion pr_descripcion, dbo.in_Producto.lote_fecha_vcto, dbo.in_Producto.lote_num_lote, dbo.fa_factura_det.vt_cantidad, dbo.fa_factura_det.vt_Precio, 
                         dbo.fa_factura_det.vt_PorDescUnitario, dbo.fa_factura_det.vt_cantidad * dbo.fa_factura_det.vt_DescUnitario AS vt_DesctTotal, dbo.fa_factura_det.vt_PrecioFinal, dbo.fa_factura_det.vt_Subtotal, dbo.fa_factura_det.vt_iva, 
                         dbo.fa_factura_det.vt_total, dbo.fa_factura.Estado, dbo.tb_sucursal.Su_Descripcion, dbo.fa_factura.vt_fecha
