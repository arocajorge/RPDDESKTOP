...
SELECT        ISNULL(ROW_NUMBER() OVER (ORDER BY dbo.ba_Cbte_Ban.IdEmpresa), 0) AS IdRow, dbo.ba_Cbte_Ban.IdEmpresa, dbo.ba_Cbte_Ban.IdCbteCble, dbo.ba_Cbte_Ban.IdTipocbte ,
