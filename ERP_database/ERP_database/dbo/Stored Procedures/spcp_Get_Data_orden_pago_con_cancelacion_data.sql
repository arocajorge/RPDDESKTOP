--exec [dbo].[spcp_Get_Data_orden_pago_con_cancelacion_data] 1,0,99999,'',1,999999,'APRO','admin',0
...
and cp_orden_pago.IdEstadoAprobacion = @IdEstado_Aprobacion and cp_orden_pago.IdPersona between @IdPersona_ini and @IdPersona_fin
