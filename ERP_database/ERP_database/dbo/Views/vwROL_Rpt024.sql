...
SELECT        dbo.tb_persona.pe_cedulaRuc AS CedulaRuc, dbo.tb_persona.pe_nombreCompleto AS NombreCompleto, dbo.ro_empleado.IdEmpleado, dbo.ro_prestamo.IdPrestamo, dbo.ro_prestamo.IdEmpresa, 
                           dbo.ro_prestamo.Estado AS EstadoPrestamo, dbo.ro_prestamo.Fecha, dbo.ro_prestamo.MontoSol, dbo.ro_prestamo.TasaInteres, 
                         ...
                         dbo.tb_persona.pe_nombre,  ro_catalogo_1.ca_descripcion AS EstadoCuota, iif(dbo.ro_prestamo_detalle.EstadoPago = 'CAN', dbo.ro_prestamo_detalle.TotalCuota, 0) AS Canceladas, 
