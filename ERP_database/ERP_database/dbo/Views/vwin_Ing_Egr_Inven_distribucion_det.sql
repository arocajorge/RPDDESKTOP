...
AS
SELECT        ISNULL(ROW_NUMBER() OVER (ORDER BY dbo.in_Ing_Egr_Inven_distribucion.IdEmpresa), 0) AS IdRow, dbo.in_Ing_Egr_Inven_distribucion.IdEmpresa, dbo.in_Ing_Egr_Inven_distribucion.IdSucursal, 
dbo.in_Ing_Egr_Inven_distribucion.IdMovi_inven_tipo, dbo.in_Ing_Egr_Inven_distribucion.IdNumMovi, dbo.in_Producto.IdProducto_padre, dbo.in_Producto.IdProducto, dbo.in_Producto.pr_descripcion, 
dbo.in_Ing_Egr_Inven_det.IdUnidadMedida, ISNULL(ABS(dbo.in_Ing_Egr_Inven_det.dm_cantidad),0)dm_cantidad, dbo.in_Ing_Egr_Inven_det.mv_costo
FROM            dbo.in_Ing_Egr_Inven_distribucion INNER JOIN
                         ...
                         dbo.in_Ing_Egr_Inven_distribucion.IdMovi_inven_tipo = mov_x_distribuir.IdMovi_inven_tipo AND dbo.in_Ing_Egr_Inven_distribucion.IdNumMovi = mov_x_distribuir.IdNumMovi INNER JOIN
...
WHERE        mov_x_distribuir.signo = in_Ing_Egr_Inven_distribucion.signo