    ...
    public partial class FrmIn_Egresos_Varios_Mant : Form
    {
        ...
        void carga_Combos()
        {
            try
            {
                ...
                if (info_parametros.P_IdMovi_inven_tipo_default_egr != null)
                    cmbTipoMovi.set_TipoMoviInvInfo(Convert.ToInt32(info_parametros.P_IdMovi_inven_tipo_default_egr));
            ...
            try
            {
                ...
                switch (Accion)
                {
                    case Cl_Enumeradores.eTipo_action.grabar:
                        ...
                        if (bus_IngEgr.GuardarDB_aprobar_contabilizar(info_IngEgr))
                        {
                            ...
                            string smensaje = string.Format(Core.Erp.Recursos.Properties.Resources.msgDespues_Grabar, "El registro del egreso a Bodega ", info_IngEgr.IdNumMovi.ToString());
                    ...
                    case Cl_Enumeradores.eTipo_action.actualizar:
                        ...
                        if (bus_IngEgr.ModificarDB_aprobar_contabilizar(info_IngEgr))
                        {
                            MessageBox.Show("Registro actualizado exitósamente", param.Nombre_sistema);
                            LimpiarDatos();
                        }
                        else
                        {
