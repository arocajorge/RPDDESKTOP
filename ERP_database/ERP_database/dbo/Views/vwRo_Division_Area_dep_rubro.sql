...
SELECT       ROW_NUMBER() OVER (ORDER BY dbo.ro_rubro_tipo.idempresa) AS IdFila, dbo.ro_Division.IdEmpresa, dbo.ro_Division.IdDivision, dbo.ro_Division.Descripcion AS DescripcionDiv, dbo.ro_area.IdArea, 
                         ...
                         dbo.ro_Config_Param_contable.IdCentroCosto,  dbo.ro_rubro_tipo.rub_noafecta, 
                         dbo.ro_rubro_tipo.rub_Acuerdo_Descuento,  dbo.ro_rubro_tipo.rub_Contabiliza_x_empleado, 
                         dbo.ro_rubro_tipo.rub_aplica_IESS,  
                          dbo.ro_rubro_tipo.rub_grupo
