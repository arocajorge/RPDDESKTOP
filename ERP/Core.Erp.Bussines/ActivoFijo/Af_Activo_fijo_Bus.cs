                ...
                if (ds.Columns.Count >= 8)
                {
                    ...
                    if (ds.Rows.Count > 0)
                    {
                        ...
                        foreach (DataRow row in ds.Rows)
                        {
                            ...
                            info.IdActivoFijoTipo = 1;
                            info.IdCategoriaAF = 1;
                            info.Estado = "A";
                            info.IdCatalogo_Marca = "TIP_MARCA_0000001";
                            info.IdCatalogo_Modelo = "TIP_MODELO_0000001";
                            ...
                            for (int col = 0; col < ds.Columns.Count + 1; col++)
                            {
                                ...
                                //{
                                    switch (col)
                                    {
                                        ...
                                        case 9://Af_Costo_historico
                                            info.Tipo = Convert.ToString(row[col]);
                                            break;

                                        case 10://Af_Costo_historico
                                            info.Categoria = Convert.ToString(row[col]);
                                            break;
