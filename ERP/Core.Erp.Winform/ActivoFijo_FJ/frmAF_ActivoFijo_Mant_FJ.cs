    ...
    public partial class frmAF_ActivoFijo_Mant_FJ : Form
    {
        ...
        private void load_combos()
        {
            try
            {
                ...
                cmbProveedor.cargar_proveedores();
            }
            catch (Exception ex)
            {
                string NameMetodo = System.Reflection.MethodBase.GetCurrentMethod().Name;
        ...
        private void set_ActivoFijo_in_controls()
        {
            try
            {
                ...
                ucGe_Sucursal_combo1.set_SucursalInfo(Info_AF.IdSucursal == null ? 0 : Convert.ToInt32(Info_AF.IdSucursal));
                this.cmb_tipo_activo_f.EditValue = Info_AF.IdActivoFijoTipo;
        ...
        public Af_Activo_fijo_Info get_ActivoFijo()
        {
            try
            {
                ...
                Info_AF.IdActivoFijoTipo = Convert.ToInt32(this.cmb_tipo_activo_f.EditValue);
