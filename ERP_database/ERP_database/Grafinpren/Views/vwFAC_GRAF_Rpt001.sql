...
SELECT        dbo.fa_guia_remision.IdEmpresa, dbo.fa_guia_remision.IdBodega, dbo.fa_guia_remision.IdSucursal, dbo.fa_guia_remision.IdGuiaRemision, 
                         ...
                         dbo.fa_guia_remision_det.Secuencia, dbo.fa_guia_remision_det.gi_cantidad,  
                         
                          dbo.fa_guia_remision_det.gi_detallexItems, dbo.tb_transportista.Nombre AS Nombre_Transportista, 
                         ...
                         Grafinpren.fa_Equipo_graf.nom_Equipo AS Nom_Maquina, Grafinpren.fa_guia_remision_graf.Num_Cotizacion,  
