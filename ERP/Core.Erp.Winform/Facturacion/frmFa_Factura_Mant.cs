    ...
    public partial class frmFa_Factura_Mant : Form
    {
        ...
        public Boolean validar()
        {
            try
            {
                ...
                if (Binding_List_Factura_det.Count > param_info.NumeroDeItemFact)
                {
                    MessageBox.Show("Ha excedido el número de items por factura, el máximo es: "+param_info.NumeroDeItemFact.ToString(), param.Nombre_sistema, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    return false;
                }
        ...
        public void ucGe_Menu_Superior_Mant1_event_btnImprimir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                lstRpt = busRpt.get_ImpresionFactura(InfoFactura.IdEmpresa, InfoFactura.IdSucursal, InfoFactura.IdBodega, InfoFactura.IdCbteVta,false);
                rptSoporte.lstRpt = lstRpt;
