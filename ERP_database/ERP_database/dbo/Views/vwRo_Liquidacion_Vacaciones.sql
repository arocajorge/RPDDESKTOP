...
SELECT        dbo.ro_rol_individual.IdEmpresa, dbo.ro_rol_individual.IdNominaTipo, dbo.ro_rol_individual.IdNominaTipoLiqui, dbo.ro_rol_individual.IdPeriodo, 
                         ...
                         dbo.ro_rubro_tipo.rub_nocontab,  dbo.ro_rubro_tipo.rub_noafecta, dbo.ro_rubro_tipo.rub_provision, 
                         dbo.ro_periodo.pe_anio, dbo.ro_periodo.pe_mes, dbo.ro_periodo.pe_FechaIni, dbo.ro_periodo.pe_FechaFin, 
