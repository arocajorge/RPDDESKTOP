...
SELECT        dbo.fa_notaCreDeb.IdEmpresa, dbo.fa_notaCreDeb.IdSucursal, dbo.fa_notaCreDeb.IdBodega, dbo.fa_notaCreDeb.IdNota, dbo.fa_notaCreDeb_det.Secuencia, dbo.fa_TipoNota.CodTipoNota, 
                         ...
                         dbo.fa_notaCreDeb.IdVendedor, dbo.tb_persona.pe_nombreCompleto, dbo.tb_persona.pe_cedulaRuc, null pe_telefonoCasa, dbo.tb_persona.pe_direccion, dbo.fa_Vendedor.Ve_Vendedor, 
                         ...
                         dbo.fa_notaCreDeb.valor1 + dbo.fa_notaCreDeb.valor2 + dbo.fa_notaCreDeb.flete AS valorFlete, dbo.fa_notaCreDeb.IdCaja, dbo.fa_factura.vt_serie1, dbo.fa_factura.vt_serie2, dbo.fa_factura.vt_NumFactura, 
