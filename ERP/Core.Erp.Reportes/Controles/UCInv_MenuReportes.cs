...
namespace Core.Erp.Reportes.Controles
{
    public partial class UCInv_MenuReportes : UserControl
    {
        ...
        ct_punto_cargo_Bus busPuntoCargo = new ct_punto_cargo_Bus();
        List<ct_punto_cargo_Info> listapuntocargo = new List<ct_punto_cargo_Info>();

        in_grupo_Bus bus_grupo = new in_grupo_Bus();
        List<in_grupo_info> lista_grupo = new List<in_grupo_info>();

        in_subgrupo_Bus bus_subgrupo = new in_subgrupo_Bus();
        List<in_subgrupo_info> lista_subgrupo = new List<in_subgrupo_info>();
        ...
        public Boolean VisiblePuntoCargo
        {
            get { return this.punto_cargo.Visible; }
            set { this.punto_cargo.Visible = value; }
        }
        ...
        public Boolean Visible_grup_sub
        {
            get { return this.grupo_grupo.Visible; }
            set { this.grupo_grupo.Visible = value; }
        }
        ...
        private void cmbLinea_EditValueChanged(object sender, EventArgs e)
        {
            try
            {
                lista_grupo = bus_grupo.Get_List_Grupo(param.IdEmpresa);
