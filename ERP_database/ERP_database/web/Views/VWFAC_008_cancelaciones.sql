CREATE VIEW [web].[VWFAC_008_cancelaciones]
AS
SELECT        fa_notaCreDeb_x_fa_factura_NotaDeb.IdEmpresa_nt, fa_notaCreDeb_x_fa_factura_NotaDeb.IdSucursal_nt, fa_notaCreDeb_x_fa_factura_NotaDeb.IdBodega_nt, fa_notaCreDeb_x_fa_factura_NotaDeb.IdNota_nt, 
                         fa_notaCreDeb_x_fa_factura_NotaDeb.secuencia,fa_notaCreDeb_x_fa_factura_NotaDeb.IdCbteVta_fac_nd_doc_mod,
						  fa_notaCreDeb_x_fa_factura_NotaDeb.Valor_Aplicado, IIF(fa_notaCreDeb_x_fa_factura_NotaDeb.vt_tipoDoc = 'FACT', 
                         fa_factura.vt_tipoDoc + '-' + fa_factura.vt_serie1 + '-' + fa_factura.vt_serie2 + '-' + fa_factura.vt_NumFactura, 
