...
{
    public partial class XINV_Rpt009_rpt : DevExpress.XtraReports.UI.XtraReport
    {
        cl_parametrosGenerales_Bus param = cl_parametrosGenerales_Bus.Instance;
        tb_sis_Log_Error_Vzen_Bus Log_Error_bus = new tb_sis_Log_Error_Vzen_Bus();

        public XINV_Rpt009_rpt()
        {
            InitializeComponent();
            xlbl_idReporte.Text = "XINV_Rpt009_rpt";
        }

        private void XINV_Rpt009_rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                lista = Bus.Get_data(IdEmpresa, IdSucursal, IdBodega, IdCategoria, IdLinea, Registro_Cero,Fecha_corte, IdProducto,IdGrupo,IdSubgrupo, ref msg);
            ...
            catch (Exception ex)
            {
                ...
                throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "XINV_Rpt009_rpt_BeforePrint", ex.Message), ex) { EntityType = typeof(XINV_Rpt009_rpt) };
            }
        }
