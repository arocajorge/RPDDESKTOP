...
dbo.ro_rubro_tipo.ru_estado, dbo.ro_rubro_tipo.ru_tipo, dbo.ro_rubro_tipo.rub_concep, dbo.ro_rubro_tipo.rub_tipcal, dbo.ro_rubro_tipo.rub_ctacon, dbo.ro_rubro_tipo.rub_nocontab, dbo.ro_rubro_tipo.rub_guarda_rol, 
dbo.ro_rubro_tipo.rub_provision, dbo.ro_Config_Param_contable.IdCtaCble, dbo.ro_Config_Param_contable.IdCtaCble_Haber, dbo.ro_Config_Param_contable.DebCre, dbo.ro_Config_Param_contable.IdCentroCosto, 
dbo.ro_rubro_tipo.rub_noafecta, dbo.ro_rubro_tipo.rub_Acuerdo_Descuento, dbo.ro_rubro_tipo.rub_Contabiliza_x_empleado, dbo.ro_rubro_tipo.rub_aplica_IESS, dbo.ro_rubro_tipo.rub_grupo 
