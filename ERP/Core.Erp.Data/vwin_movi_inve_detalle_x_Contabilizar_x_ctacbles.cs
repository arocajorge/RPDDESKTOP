...
namespace Core.Erp.Data
{
    ...
    public partial class vwin_movi_inve_detalle_x_Contabilizar_x_ctacbles
    {
        ...
        public int dm_stock_ante { get; set; }
        public int dm_stock_actu { get; set; }
        public string dm_observacion { get; set; }
        public double mv_costo { get; set; }
        public int dm_peso { get; set; }
        ...
        public Nullable<int> IdCtaCble_Inven_x_Motivo_det { get; set; }
        public Nullable<int> IdCtaCble_Costo_x_Motivo_det { get; set; }
        public string IdCtaCble_Inven_x_Prod { get; set; }
        public string IdCtaCble_Costo_x_Prod { get; set; }
        public Nullable<int> IdCtaCtble_Inve_x_SubGrupo { get; set; }
        public Nullable<int> IdCtaCtble_Costo_x_SubGrupo { get; set; }
        public Nullable<int> IdMotivo_Inv { get; set; }
        public Nullable<int> IdCtaCble_Inven_x_Motivo { get; set; }
        public Nullable<int> IdCtaCble_Costo_x_Motivo { get; set; }
