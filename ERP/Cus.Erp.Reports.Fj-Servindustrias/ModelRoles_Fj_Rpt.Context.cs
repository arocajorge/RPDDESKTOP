...
namespace Cus.Erp.Reports.FJ
{
    ...
    public partial class Entities_Roles_Fj_Rpt : DbContext
    {
        ...
        public virtual int spROLES_Rpt005(Nullable<int> idEmpresa, Nullable<int> idNomina_tipo, Nullable<System.DateTime> fecha_Inicio, Nullable<System.DateTime> fecha_Fin, Nullable<int> idperiodo)
        {
            var idEmpresaParameter = idEmpresa.HasValue ?
                new ObjectParameter("IdEmpresa", idEmpresa) :
                new ObjectParameter("IdEmpresa", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spROLES_Rpt005", idEmpresaParameter, idNomina_tipoParameter, fecha_InicioParameter, fecha_FinParameter, idperiodoParameter);
        }
        ...
        public virtual int spROLES_Rpt012(Nullable<int> idEmpresa, Nullable<int> idNomina_tipo, Nullable<int> anio, Nullable<int> mes, Nullable<int> idPeriodo)
        {
            var idEmpresaParameter = idEmpresa.HasValue ?
                new ObjectParameter("IdEmpresa", idEmpresa) :
                new ObjectParameter("IdEmpresa", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spROLES_Rpt012", idEmpresaParameter, idNomina_tipoParameter, anioParameter, mesParameter, idPeriodoParameter);
        }
        ...
        public virtual int spROLES_Rpt0051(Nullable<int> idEmpresa, Nullable<int> idNomina_tipo, Nullable<System.DateTime> fecha_Inicio, Nullable<System.DateTime> fecha_Fin, Nullable<int> idperiodo)
        {
            var idEmpresaParameter = idEmpresa.HasValue ?
                new ObjectParameter("IdEmpresa", idEmpresa) :
                new ObjectParameter("IdEmpresa", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spROLES_Rpt0051", idEmpresaParameter, idNomina_tipoParameter, fecha_InicioParameter, fecha_FinParameter, idperiodoParameter);
        }
    
        public virtual int spROLES_Rpt0121(Nullable<int> idEmpresa, Nullable<int> idNomina_tipo, Nullable<int> anio, Nullable<int> mes, Nullable<int> idPeriodo)
        {
            var idEmpresaParameter = idEmpresa.HasValue ?
                new ObjectParameter("IdEmpresa", idEmpresa) :
                new ObjectParameter("IdEmpresa", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spROLES_Rpt0121", idEmpresaParameter, idNomina_tipoParameter, anioParameter, mesParameter, idPeriodoParameter);
        }
    }
}
