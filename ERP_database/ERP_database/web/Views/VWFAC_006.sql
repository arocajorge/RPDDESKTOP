...
SELECT dbo.fa_proforma_det.IdEmpresa, dbo.fa_proforma_det.IdSucursal, dbo.fa_proforma_det.IdProforma, dbo.fa_proforma_det.Secuencia, dbo.fa_TerminoPago.nom_TerminoPago, dbo.fa_proforma.pf_plazo, dbo.fa_proforma.pf_codigo, 
                  ...
                  dbo.fa_proforma.pr_dias_entrega, dbo.fa_proforma.pf_observacion, IIF(dbo.in_Producto.se_distribuye != 1 , dbo.in_Producto.lote_num_lote, NULL) lote_num_lote,
				  IIF(dbo.in_Producto.se_distribuye != 1 , dbo.in_Producto.lote_fecha_vcto, NULL) lote_fecha_vcto
