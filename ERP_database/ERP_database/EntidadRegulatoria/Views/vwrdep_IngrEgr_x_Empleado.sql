...
FROM (
SELECT        rol_det.IdEmpresa, rol_det.IdEmpleado, rol_det.IdRubro, rol_det.Valor, per.pe_cedulaRuc, per.pe_apellido, per.pe_nombre, per.pe_sexo, per.pe_direccion, per.pe_telfono_Contacto, per.pe_celular, per.pe_correo, 
                         per.IdEstadoCivil, per.pe_fechaNacimiento, pe.pe_anio, sucr.Su_CodigoEstablecimiento, EntidadRegulatoria.vwrdep_gastos_x_rubros_deducibles.GastoAlimentacion, 
                         EntidadRegulatoria.vwrdep_gastos_x_rubros_deducibles.GastoEucacion, EntidadRegulatoria.vwrdep_gastos_x_rubros_deducibles.GastoSalud, EntidadRegulatoria.vwrdep_gastos_x_rubros_deducibles.GastoVestimenta, 
                         EntidadRegulatoria.vwrdep_gastos_x_rubros_deducibles.GastoVivienda, SUM( utilidad_det.ValorTotal)Utilidades
FROM            dbo.ro_rol AS rol INNER JOIN
                         dbo.ro_rol_detalle AS rol_det ON rol.IdEmpresa = rol_det.IdEmpresa AND rol.IdNominaTipo = rol_det.IdNominaTipo AND rol.IdNominaTipoLiqui = rol_det.IdNominaTipoLiqui AND rol.IdPeriodo = rol_det.IdPeriodo INNER JOIN
...
GROUP BY rol_det.IdEmpresa, rol_det.IdEmpleado, rol_det.IdRubro, rol_det.Valor, per.pe_cedulaRuc, per.pe_apellido, per.pe_nombre, per.pe_sexo, per.pe_direccion, per.pe_telfono_Contacto, per.pe_celular, per.pe_correo, 
                         per.IdEstadoCivil, per.pe_fechaNacimiento, pe.pe_anio, sucr.Su_CodigoEstablecimiento, EntidadRegulatoria.vwrdep_gastos_x_rubros_deducibles.GastoAlimentacion, 
                         EntidadRegulatoria.vwrdep_gastos_x_rubros_deducibles.GastoEucacion, EntidadRegulatoria.vwrdep_gastos_x_rubros_deducibles.GastoSalud, EntidadRegulatoria.vwrdep_gastos_x_rubros_deducibles.GastoVestimenta, 
                         EntidadRegulatoria.vwrdep_gastos_x_rubros_deducibles.GastoVivienda
) as s
PIVOT
(
   sum([Valor])
...
FROM            dbo.ro_rubro_tipo AS rub INNER JOIN
                         ...
                         dbo.ro_periodo_x_ro_Nomina_TipoLiqui AS pe_nom ON rol_det.IdEmpresa = pe_nom.IdEmpresa AND rol_det.IdNominaTipo = pe_nom.IdNomina_Tipo AND rol_det.IdNominaTipoLiqui = pe_nom.IdNomina_TipoLiqui AND 
                         rol_det.IdPeriodo = pe_nom.IdPeriodo INNER JOIN
...
GROUP BY rol_det.IdEmpresa, rol_det.IdEmpleado, ro_pe.pe_anio
) Ingresos_varios
on Ingresos_fijos.IdEmpresa=Ingresos_varios.IdEmpresa
and Ingresos_fijos.IdEmpleado=Ingresos_varios.IdEmpleado
and Ingresos_fijos.pe_anio=Ingresos_varios.pe_anio