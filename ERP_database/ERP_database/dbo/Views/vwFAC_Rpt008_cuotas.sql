...
AS
SELECT isnull(ROW_NUMBER() over(order by IdEmpresa),0) as IdRow,  * FROM(
SELECT dbo.fa_factura_det.IdEmpresa, dbo.fa_factura_det.IdSucursal, dbo.fa_factura_det.IdBodega, dbo.fa_factura_det.IdCbteVta, dbo.fa_factura_det.Secuencia, dbo.fa_factura.vt_tipoDoc, dbo.fa_factura.vt_serie1, dbo.fa_factura.vt_serie2, 
                  ...
                  dbo.fa_Vendedor.Ve_Vendedor, dbo.fa_factura.vt_fech_venc, dbo.in_Producto.lote_fecha_fab, dbo.in_Producto.lote_fecha_vcto, dbo.in_Producto.lote_num_lote, dbo.tb_persona.pe_razonSocial, 1 orden
...
UNION ALL
SELECT dbo.fa_factura_det.IdEmpresa, dbo.fa_factura_det.IdSucursal, dbo.fa_factura_det.IdBodega, dbo.fa_factura_det.IdCbteVta, dbo.fa_factura_det.Secuencia, dbo.fa_factura.vt_tipoDoc, dbo.fa_factura.vt_serie1, dbo.fa_factura.vt_serie2, 
                  dbo.fa_factura.vt_NumFactura, dbo.fa_factura.vt_fecha, dbo.fa_factura.Estado, dbo.fa_factura_det.IdProducto,'MARCA: ' + in_Marca.Descripcion, 0 AS Expr1, 0 AS Expr2, 0 AS Expr3, dbo.fa_factura_det.vt_detallexItems, 
                  dbo.fa_factura.IdCliente, dbo.fa_cliente_contactos.Nombres, dbo.tb_persona.pe_cedulaRuc, dbo.fa_cliente_contactos.Direccion, dbo.fa_cliente_contactos.Telefono, dbo.fa_factura.vt_Observacion, 0 AS Expr4, dbo.fa_factura.vt_mes, 
                  dbo.fa_factura.vt_anio, 0 AS Expr5, 0 AS Expr6, 0 AS Expr7, 0 AS Expr8, 0 AS Expr9, 0 AS Expr10, 0 AS Expr11, 0 AS Expr12, 0 AS Expr13, in_Producto.pr_descripcion_2, dbo.tb_sis_Impuesto.nom_impuesto, dbo.tb_ciudad.Descripcion_Ciudad, dbo.fa_Vendedor.Codigo, 
                  0 AS Expr14, 0 AS Expr15, 0 AS Expr16, dbo.fa_Vendedor.Ve_Vendedor, dbo.fa_factura.vt_fech_venc, NULL AS Expr17, NULL AS Expr18, NULL AS Expr19, dbo.tb_persona.pe_razonSocial, 2 orden
FROM     dbo.fa_factura_det INNER JOIN
				  ...
				  UNION ALL
SELECT dbo.fa_factura_det.IdEmpresa, dbo.fa_factura_det.IdSucursal, dbo.fa_factura_det.IdBodega, dbo.fa_factura_det.IdCbteVta, dbo.fa_factura_det.Secuencia, dbo.fa_factura.vt_tipoDoc, dbo.fa_factura.vt_serie1, dbo.fa_factura.vt_serie2, 
                  dbo.fa_factura.vt_NumFactura, dbo.fa_factura.vt_fecha, dbo.fa_factura.Estado, dbo.fa_factura_det.IdProducto,'MODELO: ' + in_presentacion.nom_presentacion, 0 AS Expr1, 0 AS Expr2, 0 AS Expr3, dbo.fa_factura_det.vt_detallexItems, 
                  dbo.fa_factura.IdCliente, dbo.fa_cliente_contactos.Nombres, dbo.tb_persona.pe_cedulaRuc, dbo.fa_cliente_contactos.Direccion, dbo.fa_cliente_contactos.Telefono, dbo.fa_factura.vt_Observacion, 0 AS Expr4, dbo.fa_factura.vt_mes, 
                  dbo.fa_factura.vt_anio, 0 AS Expr5, 0 AS Expr6, 0 AS Expr7, 0 AS Expr8, 0 AS Expr9, 0 AS Expr10, 0 AS Expr11, 0 AS Expr12, 0 AS Expr13, in_Producto.pr_descripcion_2, dbo.tb_sis_Impuesto.nom_impuesto, dbo.tb_ciudad.Descripcion_Ciudad, dbo.fa_Vendedor.Codigo, 
                  0 AS Expr14, 0 AS Expr15, 0 AS Expr16, dbo.fa_Vendedor.Ve_Vendedor, dbo.fa_factura.vt_fech_venc, NULL AS Expr17, NULL AS Expr18, NULL AS Expr19, dbo.tb_persona.pe_razonSocial, 3 orden
FROM     dbo.fa_factura_det INNER JOIN
                  dbo.fa_factura ON dbo.fa_factura_det.IdEmpresa = dbo.fa_factura.IdEmpresa AND dbo.fa_factura_det.IdSucursal = dbo.fa_factura.IdSucursal AND dbo.fa_factura_det.IdBodega = dbo.fa_factura.IdBodega AND 
                  dbo.fa_factura_det.IdCbteVta = dbo.fa_factura.IdCbteVta INNER JOIN
                  dbo.in_Producto ON dbo.fa_factura_det.IdEmpresa = dbo.in_Producto.IdEmpresa AND dbo.fa_factura_det.IdProducto = dbo.in_Producto.IdProducto INNER JOIN
				  ...
				  UNION ALL
SELECT dbo.fa_factura.IdEmpresa, dbo.fa_factura.IdSucursal, dbo.fa_factura.IdBodega, dbo.fa_factura.IdCbteVta, 25 AS Expr20, dbo.fa_factura.vt_tipoDoc, dbo.fa_factura.vt_serie1, dbo.fa_factura.vt_serie2, dbo.fa_factura.vt_NumFactura, 
                  dbo.fa_factura.vt_fecha, dbo.fa_factura.Estado, 0 AS Expr1, fa_factura.vt_Observacion AS Expr21, 0 AS Expr2, 0 AS Expr3, 0 AS Expr4, '' AS Expr22, dbo.fa_factura.IdCliente, dbo.fa_cliente_contactos.Nombres, dbo.tb_persona.pe_cedulaRuc, 
                  dbo.fa_cliente_contactos.Direccion, dbo.fa_cliente_contactos.Telefono, dbo.fa_factura.vt_Observacion, 0 AS Expr5, dbo.fa_factura.vt_mes, dbo.fa_factura.vt_anio, 0 AS Expr6, 0 AS Expr7, 0 AS Expr8, 0 AS Expr9, 0 AS Expr10, 0 AS Expr11, 
                  0 AS Expr12, 0 AS Expr13, 0 AS Expr14, '' AS Expr23, '' AS Expr24, dbo.tb_ciudad.Descripcion_Ciudad, dbo.fa_Vendedor.Codigo, 0 AS Expr15, 0 AS Expr16, 0 AS Expr25, dbo.fa_Vendedor.Ve_Vendedor, dbo.fa_factura.vt_fech_venc, NULL 
                  AS Expr17, NULL AS Expr18, NULL AS Expr19, dbo.tb_persona.pe_razonSocial, 4 AS orden
FROM     dbo.fa_factura INNER JOIN
                  dbo.fa_cliente_contactos ON dbo.fa_factura.IdEmpresa = dbo.fa_cliente_contactos.IdEmpresa AND dbo.fa_factura.IdCliente = dbo.fa_cliente_contactos.IdCliente AND 
                  dbo.fa_factura.IdContacto = dbo.fa_cliente_contactos.IdContacto INNER JOIN
                  dbo.fa_cliente ON dbo.fa_factura.IdEmpresa = dbo.fa_cliente.IdEmpresa AND dbo.fa_factura.IdCliente = dbo.fa_cliente.IdCliente AND dbo.fa_cliente_contactos.IdEmpresa = dbo.fa_cliente.IdEmpresa AND 
				  ...
				  UNION ALL
SELECT dbo.fa_factura.IdEmpresa, dbo.fa_factura.IdSucursal, dbo.fa_factura.IdBodega, dbo.fa_factura.IdCbteVta, 100 + fa_cuotas_x_doc.secuencia AS Expr20, dbo.fa_factura.vt_tipoDoc, dbo.fa_factura.vt_serie1, dbo.fa_factura.vt_serie2, dbo.fa_factura.vt_NumFactura, 
                  dbo.fa_factura.vt_fecha, dbo.fa_factura.Estado, 0 AS Expr1, CONVERT(varchar(10), fa_cuotas_x_doc.fecha_vcto_cuota, 103)+'    '+ cast(FORMAT(fa_cuotas_x_doc.valor_a_cobrar, 'C', 'en-us') as varchar(20)) AS Expr21, 0 AS Expr2, 0 AS Expr3, 0 AS Expr4, '' AS Expr22, dbo.fa_factura.IdCliente, dbo.fa_cliente_contactos.Nombres, dbo.tb_persona.pe_cedulaRuc, 
                  dbo.fa_cliente_contactos.Direccion, dbo.fa_cliente_contactos.Telefono, dbo.fa_factura.vt_Observacion, 0 AS Expr5, dbo.fa_factura.vt_mes, dbo.fa_factura.vt_anio, 0 AS Expr6, 0 AS Expr7, 0 AS Expr8, 0 AS Expr9, 0 AS Expr10, 0 AS Expr11, 
                  0 AS Expr12, 0 AS Expr13, 0 AS Expr14, '' AS Expr23, '' AS Expr24, dbo.tb_ciudad.Descripcion_Ciudad, dbo.fa_Vendedor.Codigo, 0 AS Expr15, 0 AS Expr16, 0 AS Expr25, dbo.fa_Vendedor.Ve_Vendedor, dbo.fa_factura.vt_fech_venc, NULL 
                  AS Expr17, NULL AS Expr18, NULL AS Expr19, dbo.tb_persona.pe_razonSocial, 5 AS orden
FROM     dbo.fa_factura INNER JOIN
                  dbo.fa_cliente_contactos ON dbo.fa_factura.IdEmpresa = dbo.fa_cliente_contactos.IdEmpresa AND dbo.fa_factura.IdCliente = dbo.fa_cliente_contactos.IdCliente AND 
                  dbo.fa_factura.IdContacto = dbo.fa_cliente_contactos.IdContacto INNER JOIN
                  dbo.fa_cliente ON dbo.fa_factura.IdEmpresa = dbo.fa_cliente.IdEmpresa AND dbo.fa_factura.IdCliente = dbo.fa_cliente.IdCliente AND dbo.fa_cliente_contactos.IdEmpresa = dbo.fa_cliente.IdEmpresa AND 
                  ...
                  dbo.fa_factura.IdCbteVta = dbo.fa_cuotas_x_doc.IdCbteVta
) AS A