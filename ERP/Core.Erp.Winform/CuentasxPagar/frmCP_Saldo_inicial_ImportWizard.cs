...
{
    public partial class frmCP_Saldo_inicial_ImportWizard : Form
    {
        string MensajeError = "";
        ...
        public frmCP_Saldo_inicial_ImportWizard()
        {
            InitializeComponent();
            event_delegate_FormClosing += frmCP_Saldo_inicial_ImportWizard_event_delegate_FormClosing;
        }

        void frmCP_Saldo_inicial_ImportWizard_event_delegate_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            try
            {
                ...
                if (this.gridControlND_Saldo_inicial.DataSource != null)
                {
                    ...
                    {                        
                        ...
                        {
                            ListEstadoGrabacion.Add(new cl_estado_grabacion_Saldo_inicial_ND(secuencia, item.IdProveedor,item.InfoProveedor.pr_nombre, item.IdTipoCbte_Nota, item.IdCbteCble_Nota, item.cod_nota, item.cn_fecha, Convert.ToDateTime(item.cn_Fecha_vcto), Convert.ToDateTime(item.Fecha_contable), Convert.ToDouble(item.cn_total)));
        ...
        private void frmCP_Saldo_inicial_ImportWizard_Load(object sender, EventArgs e)
        {
            cmbHoja.SelectedIndex = 0;
        }
        ...
        private void frmCP_Saldo_inicial_ImportWizard_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        {
            gridControlND_Saldo_inicial.ShowPrintPreview();
        }
    }
