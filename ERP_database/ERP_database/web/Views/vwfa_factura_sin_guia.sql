...
SELECT        f.IdEmpresa, f.IdSucursal, f.IdBodega, f.IdCbteVta, f.CodCbteVta,f.IdCliente, f.vt_tipoDoc, f.vt_serie1, f.vt_serie2, f.vt_NumFactura, f.vt_Observacion
...
and f.Estado='A'
group by 
 f.IdEmpresa, f.IdSucursal, f.IdBodega, f.IdCbteVta, f.CodCbteVta,f.IdCliente, f.vt_tipoDoc, f.vt_serie1, f.vt_serie2, f.vt_NumFactura, f.vt_Observacion