...
UNION ALL
SELECT        A.IdEmpresa, A.IdSucursal, A.IdBodega, A.IdProducto_combo, A.pr_codigo, A.pr_descripcion, A.IdProducto_padre, A.lote_fecha_fab, A.lote_fecha_vcto, A.lote_num_lote, ISNULL(MIN(A.cantidad),0) AS cantidad
FROM            (SELECT        dbo.in_movi_inve_detalle.IdEmpresa, dbo.in_movi_inve_detalle.IdSucursal, dbo.in_movi_inve_detalle.IdBodega, dbo.in_Producto.IdProducto, in_Producto_1.pr_codigo, in_Producto_1.pr_descripcion, 
                                                    ...
                                                    in_Producto_Composicion.IdProductoPadre AS IdProducto_combo
