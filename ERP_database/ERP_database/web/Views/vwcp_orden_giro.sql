...
SELECT        dbo.cp_orden_giro.IdEmpresa, dbo.cp_orden_giro.IdCbteCble_Ogiro, dbo.cp_orden_giro.IdTipoCbte_Ogiro, dbo.cp_orden_giro.IdOrden_giro_Tipo, dbo.cp_orden_giro.IdProveedor, dbo.cp_orden_giro.co_fechaOg, 
                         ...
                         dbo.cp_orden_giro.IdCod_ICE, dbo.cp_orden_giro.co_Ice_base, dbo.cp_orden_giro.co_Ice_por, dbo.cp_orden_giro.co_Ice_valor, dbo.cp_orden_giro.co_Serv_por, dbo.cp_orden_giro.co_Serv_valor, 
                         dbo.cp_orden_giro.co_OtroValor_a_descontar, dbo.cp_orden_giro.co_OtroValor_a_Sumar, dbo.cp_orden_giro.co_BaseSeguro, dbo.cp_orden_giro.co_total, dbo.cp_orden_giro.co_vaCoa, dbo.cp_orden_giro.IdIden_credito, 
                         dbo.cp_orden_giro.IdCod_101, dbo.cp_orden_giro.co_valorpagar, dbo.cp_orden_giro.IdTipoFlujo, dbo.cp_orden_giro.IdTipoServicio, dbo.cp_orden_giro.IdCtaCble_Gasto, dbo.cp_orden_giro.IdCtaCble_IVA, 
                         dbo.cp_orden_giro.Estado, dbo.cp_orden_giro.co_retencionManual, dbo.cp_orden_giro.IdCbteCble_Anulacion, dbo.cp_orden_giro.IdTipoCbte_Anulacion, dbo.cp_orden_giro.IdCentroCosto, dbo.cp_orden_giro.IdSucursal, 
                         ...
                         dbo.cp_orden_giro.Num_Autorizacion, dbo.cp_orden_giro.Num_Autorizacion_Imprenta, dbo.cp_orden_giro.co_propina, dbo.cp_orden_giro.co_IRBPNR, dbo.cp_orden_giro.es_retencion_electronica, 
