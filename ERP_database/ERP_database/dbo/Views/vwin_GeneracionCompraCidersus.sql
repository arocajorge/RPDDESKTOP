...
SELECT     dbo.com_ordencompra_local.IdEmpresa, dbo.com_ordencompra_local.IdSucursal, dbo.com_ordencompra_local.IdOrdenCompra, 
                      dbo.com_ordencompra_local.IdProveedor, dbo.com_ordencompra_local.oc_NumDocumento, dbo.com_ordencompra_local.Tipo, 
                      dbo.com_ordencompra_local.IdTerminoPago, dbo.com_ordencompra_local.oc_plazo, dbo.com_ordencompra_local.oc_fecha, dbo.com_ordencompra_local.oc_flete, 
                      ...
                      dbo.com_ordencompra_local.IdEstadoRecepcion_cat AS EstadoRecepcion, dbo.com_ordencompra_local.AfectaCosto, dbo.com_ordencompra_local.MotivoAnulacion, 
                      dbo.com_ordencompra_local.MotivoReprobacion, dbo.com_ordencompra_local.Solicitante, dbo.com_ordencompra_local.IdSolicitante AS IdPersona_Sol, 
                      ...
                      dbo.com_ordencompra_local_det.do_observacion, dbo.com_ordencompra_local_det.do_peso, dbo.com_ordencompra_local_det.do_Costeado, 
                      dbo.com_ordencompra_local_det.do_ManejaIva, dbo.com_ordencompra_local_det.do_total, dbo.com_ordencompra_local_det.do_iva, 
