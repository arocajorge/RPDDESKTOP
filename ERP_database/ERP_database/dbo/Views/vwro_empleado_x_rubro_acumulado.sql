CREATE VIEW dbo.vwro_empleado_x_rubro_acumulado
AS
SELECT        dbo.ro_empleado_x_rubro_acumulado.IdEmpresa, dbo.ro_empleado_x_rubro_acumulado.IdEmpleado, dbo.ro_empleado_x_rubro_acumulado.IdRubro, dbo.ro_empleado_x_rubro_acumulado.Fec_Inicio_Acumulacion, 
                         dbo.ro_empleado_x_rubro_acumulado.Fec_Fin_Acumulacion, dbo.ro_rubro_tipo.ru_descripcion, dbo.tb_persona.pe_nombreCompleto, dbo.tb_persona.pe_apellido, dbo.tb_persona.pe_nombre, dbo.tb_persona.pe_cedulaRuc, 
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[51] 4[5] 2[5] 3) )"
      End
   ...
   Begin DiagramPane = 
      ...
      Begin Tables = 
         Begin Table = "ro_empleado"
            ...
            TopColumn = 0
         End
         Begin Table = "ro_empleado_x_rubro_acumulado"
            Begin Extent = 
               Top = 0
               Left = 436
               Bottom = 336
