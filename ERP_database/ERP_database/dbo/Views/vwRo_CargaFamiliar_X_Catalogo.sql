...
AS
SELECT        A.IdEmpresa, A.IdCargaFamiliar, A.IdEmpleado, A.Cedula, A.Sexo, A.TipoFamiliar, B.ca_descripcion, A.Nombres, A.FechaNacimiento, A.Estado, A.capacidades_especiales, A.FechaDefucion
FROM            dbo.ro_cargaFamiliar AS A INNER JOIN
