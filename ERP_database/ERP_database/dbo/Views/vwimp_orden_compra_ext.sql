...
SELECT        dbo.imp_orden_compra_ext.IdEmpresa, dbo.imp_orden_compra_ext.IdOrdenCompra_ext, dbo.imp_orden_compra_ext.IdProveedor, dbo.imp_orden_compra_ext.IdPais_origen, dbo.imp_orden_compra_ext.IdPais_embarque, 
                         dbo.imp_orden_compra_ext.IdCiudad_destino, dbo.imp_orden_compra_ext.IdCatalogo_via, dbo.imp_orden_compra_ext.codigo_pago_sri, dbo.imp_orden_compra_ext.oe_fecha, 
                         ...
                         dbo.imp_orden_compra_ext.oe_observacion, dbo.imp_orden_compra_ext.oe_codigo, dbo.imp_orden_compra_ext.oe_valor_flete, dbo.imp_orden_compra_ext.oe_valor_seguro, dbo.imp_orden_compra_ext.estado, 
                         dbo.imp_orden_compra_ext.IdLiquidacion, dbo.imp_orden_compra_ext.oe_fecha_llegada, dbo.imp_orden_compra_ext.oe_fecha_embarque, dbo.imp_orden_compra_ext.oe_fecha_desaduanizacion, 
                         dbo.tb_persona.pe_nombreCompleto, dbo.tb_persona.pe_cedulaRuc, dbo.vwimp_orden_compra_ext_con_saldo.cantidad_x_recibir, dbo.vwimp_orden_compra_ext_con_saldo.cantidad_global
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[55] 4[5] 2[8] 3) )"
      End
